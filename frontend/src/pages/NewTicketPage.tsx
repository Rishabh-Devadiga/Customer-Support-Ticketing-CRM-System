...
export default function NewTicketPage() {
  ...
  return (
    <section aria-labelledby="new-ticket-heading">
      ...
      <div className="mt-4 max-w-2xl rounded border border-slate-200 bg-white p-6">
        <TicketForm
          values={values}
          errors={shownErrors}
          isValid={isValid}
        ...
        <Link
          to="/"
          className="mt-4 inline-block rounded border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
        >
          Cancel
        </Link>
      </div>
